...
class Player extends Character implements KeyListener {
  ...
  public void keyPressed(KeyEvent e) {
    ...
    ) keyIsPressed[Direction.UP] = true; else if (
      e.getKeyCode() == KeyEvent.VK_DOWN || e.getKeyCode() == KeyEvent.VK_S
    ) keyIsPressed[Direction.DOWN] = true; else if (
      e.getKeyCode() == KeyEvent.VK_LEFT || e.getKeyCode() == KeyEvent.VK_A
    ) keyIsPressed[Direction.LEFT] = true; else if (
  ...
  public void keyReleased(KeyEvent e) {
    if (
      e.getKeyCode() == KeyEvent.VK_UP || e.getKeyCode() == KeyEvent.VK_W
    ) keyIsPressed[Direction.UP] = false; else if (
      e.getKeyCode() == KeyEvent.VK_DOWN || e.getKeyCode() == KeyEvent.VK_S
    ) keyIsPressed[Direction.DOWN] = false; else if (
      e.getKeyCode() == KeyEvent.VK_LEFT || e.getKeyCode() == KeyEvent.VK_A
    ) keyIsPressed[Direction.LEFT] = false; else if (
      e.getKeyCode() == KeyEvent.VK_RIGHT || e.getKeyCode() == KeyEvent.VK_D
